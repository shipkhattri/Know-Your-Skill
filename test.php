...
function subjectValidate(){
	...
	string="<div class=\"col-lg-12 no-pdd\">"+
				"<div class=\"sn-field\"><select name=\"subject\">"+string+
...
<form class="register-form" name="RegForm" id="register-form" action="test.php" method="POST">
										<div class="row">
										<br><br><br>
  ...
  title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters" placeholder="Password" required>
												...
												<div class="col-lg-12 no-pdd">
													<div class="sn-field">
												        <div class="g-recaptcha" data-sitekey="6Lfs4qgZAAAAAPVaq9cYBk9LZW-CoUsKzNUVUlUv" required></div>
